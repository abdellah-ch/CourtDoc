                ...
                <div dir='rtl' className="max-h-[300px] overflow-y-auto">
                    {filteredItems.length > 0 ? (
                        filteredItems.map(item => (
                            <SelectItem
                                key={item.IdUtilisateur || item.IdFiliere || item.IdGroupeFiliere || item.IdSource}
                                value={item.IdUtilisateur?.toString() || item.IdFiliere?.toString() || item.IdGroupeFiliere?.toString() || item.IdSource.toString()}
