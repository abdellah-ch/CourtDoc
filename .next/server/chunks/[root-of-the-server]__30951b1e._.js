...
async function GET() {
    try {
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].utilisateurs.findMany({
            include: {
                Roles: true,
                Cadre: true,
                UserFonctionne: true
...
async function POST(request) {
    try {
        ...
        const newUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].utilisateurs.create({
            data: body
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__30951b1e._.js.map